...
const ProjectOverview = () => {
    ...
    return currentWorkspace && (
        <div className="bg-white dark:bg-linear-to-br border border-zinc-200 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-200 rounded-lg overflow-hidden">
